...
df = pd.read_csv('/home/koushik/workspace/Projects/MLOPS/data/raw/lgg-mri-segmentation/kaggle_3m/data.csv')


data_map = []
for directory in glob.glob('/home/koushik/workspace/Projects/MLOPS/data/raw/lgg-mri-segmentation/kaggle_3m/*'):
    try:
...
common_file_length = 123 # Any file with its absolute file path has minimum characters in the file name
